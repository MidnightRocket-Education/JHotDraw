...
public class StrokeToolBar extends AbstractToolBar {
    ...
    private static final String PALETTE_COMPONENT = "PALETTE_COMPONENT";
    ...
    public void setEditor(DrawingEditor newValue) {
        ...
        createStrokeJointSlider();
        return p;
    }

    protected JComponent createDisclosedComponentState2(int state) {
        case 2:
        p = new JPanel();
        p.setOpaque(false);
        ...
        colorField.putClientProperty(PALETTE_COMPONENT + ".segmentPosition", "first");
        ...
        opacityField.putClientProperty(PALETTE_COMPONENT + ".segmentPosition", "first");
        ...
        //dashOffsetField.putClientProperty("PALETTE_COMPONENT.segmentPosition", "first");
